...
def _process_genome_attri_tools(genome_attr_tools: set[str],
    ...
    create_import_files(root_dir, env, kbase_collection, load_ver, output, docs, file_group)

    meta_output = f'{kbase_collection}_{load_ver}_{"_".join(genome_attr_tools)}_{names.COLL_GENOME_ATTRIBS_META}.jsonl'
    create_import_files(root_dir, env, kbase_collection, load_ver, meta_output, [meta_doc], file_group)
    ...
    create_import_files(root_dir, env, kbase_collection, load_ver, export_types_output, [types_doc], file_group)
...
def main():
    ...
    _process_heatmap_tools(set(HEATMAP_TOOLS).intersection(tools),
                           root_dir,
                           env,
                           kbase_collection,
                           load_ver,
