...
def _update_docs_with_upa_info(res_dict, meta_lookup, check_genome_upa):
...
def _process_genome_attri_tools(genome_attr_tools: set[str],
    ...
    docs, encountered_types = _update_docs_with_upa_info(res_dict, meta_lookup, check_genome_upa)
...
def main():
    ...
    optional.add_argument('--check_genome_upa', action="store_true", help=f'Check if genome_upa exists')
    ...
    check_genome_upa = args.check_genome_upa
    ...
    _process_genome_attri_tools(set(GENOME_ATTR_TOOLS).intersection(tools), root_dir, kbase_collection, load_ver, check_genome_upa)
