...
for importing into ArangoDB. The resulting JSON file will be used to upsert the database with the parsed genome
attribute data.
...
required named arguments:
  ...
  --load_ver LOAD_VER   KBase load version (e.g. r207.kbase.1). This argument should be consistent with the one used by the
                        gtdb_genome_attribs_loader.py script.

optional arguments:
  --kbase_collection KBASE_COLLECTION
                        KBase collection identifier name (default: loader_common_names.DEFAULT_KBASE_COLL_NAME).
                        This argument should be consistent with the one used by the gtdb_genome_attribs_loader.py script.
  --root_dir ROOT_DIR   Root directory.
  -o OUTPUT, --output OUTPUT
                        output JSON file path (default: gtdb_computed_genome_attribs.json)
...
from src.loaders.gtdb.gtdb_loader_helper import convert_to_json, init_genome_atrri_doc
...
NOTIFICATION = ' This argument should be consistent with the one used by the gtdb_genome_attribs_loader.py script.'
...
def main():
    ...
    optional.add_argument("-o", "--output", type=argparse.FileType('w'),
                          default=GTDB_COMPUTED_GENOME_ATTR_FILE,
                          help=f"output JSON file path (default: {GTDB_COMPUTED_GENOME_ATTR_FILE})")
    ...
    # TODO: merge docs from different tools with the same '_key' if performance may be an issue
